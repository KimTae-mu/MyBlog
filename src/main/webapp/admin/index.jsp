...
<div class="container">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <p><a class="btn btn-primary btn-sm" href="${pageContext.request.contextPath }/Article/write" role="button">写博客</a></p>
        </div>
        ...
        <table class="table">
            ...
            <c:forEach begin="0" var="article" items="${articles }" step="1">
                <tr>
                    ...
                    <td><a href="${pageContext.request.contextPath }/Article/update/${article.id }">修改</a></td>
                    <td><a href="${pageContext.request.contextPath }/Article/delete/${article.id }">删除</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
